...
(function() {
    ...
    function setupRemind() {
        ...
        var content_overview = [
            ...
            '<p>&nbsp;&nbsp;&nbsp;&nbsp;密钥：<scan id="overview_token">' + (token || '未设置!') + '</scan></p>',
        ...
        layer.tab({
            ...
            success: function(layero, index) {
                ...
                body.context.getElementById("save_remind_token").onclick = function() {
                    ...
                    body.context.getElementById("overview_token").innerHTML = value;
                }
