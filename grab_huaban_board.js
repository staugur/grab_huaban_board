...
// @exclude      http*://huaban.com/all*
// @exclude      http*://huaban.com/discovery*
// @exclude      http*://huaban.com/favorite*
// @exclude      http*://huaban.com/categories*
// @exclude      http*://huaban.com/apps*
// @exclude      http*://huaban.com/about*
// @exclude      http*://huaban.com/search*
// @exclude      http*://huaban.com/activities*
// @exclude      http*://huaban.com/settings*
// @exclude      http*://huaban.com/users*
// @exclude      http*://huaban.com/friends*
// @exclude      http*://huaban.com/partner*
// @exclude      http*://huaban.com/message*
// @exclude      http*://huaban.com/muse*
// @exclude      http*://huaban.com/login*
// @exclude      http*://huaban.com/signup*
// @exclude      http*://huaban.com/go*
	...
	*/
	if (window.location.pathname.split('/')[1] === "boards") {
		...
		if (hasId("user_page") === true) {
			...
			//var isUserHome = arrayContains(["all", "discovery", "favorite", "categories", "apps", "about", "search", "activities", "settings", "users", "friends", "partner", "message"], user_id) === false
			//定位
